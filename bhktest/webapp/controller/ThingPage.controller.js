sap.ui.define([
	...
	"bhktest/model/formatter"
], function (Controller, formatter) {
	"use strict";

	return Controller.extend("bhktest.controller.ThingPage", {
		formatter: formatter,
		onInit: function () {
		...
		_readDetailsService: function (oDetailsModel, sThingId) {
			...
			oDetailsModel.read("/Things('" + sThingId + "')", {
				urlParameters: {
					"$expand": "DYN_ENT_dapt_ox181026100231_adi_tanks_rest__nm_calculated,DYN_ENT_dapt_ox181026100231_adi_tanks_rest__NozzleMeter,DYN_ENT_dapt_ox181026100231_adi_tanks_rest__Image,DYN_ENT_dapt_ox181026100231_adi_tanks_rest__nm_masterdata"
				},
